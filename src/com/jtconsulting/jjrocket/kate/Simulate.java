...
public class Simulate {
	...
	public static void main(String[] args) {
		...
		s1.setR(0.019);
		s1.setY(0.250);
		s1.setMax_angular_speed((Math.PI/3)/0.10);
		s1.setAng_y(0);
		...
		s2.setR(0.019);
		s2.setY(0.250);
		s2.setMax_angular_speed((Math.PI/3)/0.10);
		s2.setAng_y(Math.PI);
		...
		double offset = 0.7;  // 1/2 angle between final resting place of smoothers
		...
		for (int n = 0; n < num_intervals; n++) {
			...
			double angle_deviation1 =   0.35356;
			double angle_deviation2 =   0.0;
			double angle_deviation3 =   0.35355;			
